 ...
 * @link       https://github.com/ekkamai/watchman
 */

/** @apikey you need to register for a google api key and update it below */

	$api_key = "XXXXXXXXXXXXXX-XXXXXXXXXXXX"; // e.g. XXXXXXXXXXXXXX-XXXXXXXXXXXX
...
/** @sendPostData primary function that queries */
	...
	//find threat type
		...
		if (isset($threat))
			...
			{
			$status = "CLEAN"; //didnt return with a threat, so lets assume its clean
			}
